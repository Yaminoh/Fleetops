...
<head>
    ...
    <title>Forgot password | Archon Nell Incorporated</title>
...
<body>
    <section class="card" aria-labelledby="forgot-heading">
        <h2 id="forgot-heading">Forgot your password?</h2>
        <p class="lead">Enter the email address on your account and we'll send you a link to reset your password.</p>
